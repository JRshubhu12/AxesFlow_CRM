...
import { Settings as SettingsIcon, Bell, CreditCard, Palette, Download, Upload, Calendar as CalendarIconLucide } from 'lucide-react'; // Updated import
    ...
    <MainLayout>
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Calendar View */}
          <Card className="shadow-lg md:col-span-1"> {/* Changed from md:col-span-2 for better balance if needed */}
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><CalendarIconLucide className="h-5 w-5 text-primary" />Calendar</CardTitle>
              <CardDescription>View your calendar.</CardDescription>
            </CardHeader>
